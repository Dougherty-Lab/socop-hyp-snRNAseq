...
ggsave(filename = './SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/250214_FosGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave(filename = './SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/250214_JunGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave(filename = './SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/250214_ArcGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
write.csv(cluster_ieg_genotype_comparison, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_activationpercent_bygeno.csv", row.names = FALSE)
```
...
# # Write the results to a CSV file
write.csv(cluster_ieg_Sex_comparison, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_activationpercent_bysex.csv", row.names = FALSE)
```
...
# # Write the results to a CSV file
write.csv(cluster_ieg_Learner_comparison, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_activationpercent_bylearner.csv", row.names = FALSE)
```
...
cluster_ieg_Geno_percentages$Cluster <- factor(cluster_ieg_Geno_percentages$Cluster,
                                              levels = sort(as.numeric(levels(combined.neuronal))))
...
wrap_plots(p1, p2)
ggsave('./SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/240716-activationbyGeno_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
wrap_plots(p1, p2)
ggsave('./SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/-activationbySex_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
wrap_plots(p1, p2)
ggsave('./SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/250116-activationbyLearner_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
ggsave('./SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/250116-activationbyLearner_neuronal_1-5_5pct_50_1.8_sigonly.pdf',
       device = pdf,
       width = 5,
       height = 8)
```
...
# # Write the results to a CSV file
write.csv(cluster_regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_rewards_byactivationpercent.csv", row.names = FALSE)
```
...
dir.create("./SocOp_MYT1L_snRNAseq_SS19_240328/results/RewardsbyActivatedPercentage_250213", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/RewardsbyActivatedPercentage_250213/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# Write the results to a CSV file
write.csv(regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_rewards_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/RewardsbyActivatedPercentage_250213/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
# Write the results to a CSV file
write.csv(regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_rewards_byactivationpercent_bysaclearner.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/RewardsbyActivatedPercentage_250213/cluster_", cluster, "_plot_bySac_Learner.pdf"), width = 6, height = 8)
...
# Save the  plot
pdf(file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/RewardsbyActivatedPercentage_250213/control_all_neurons_plot.pdf",
   width = 6, height = 8)
...
write.csv(overall_stats,
          file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_Rewards_byactivationpercent_allneurons.csv",
          row.names = FALSE)
```
...
pdf(file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/RewardsbyActivatedPercentage_250213/control_all_neurons_plot_bySex.pdf",
    width = 6, height = 8)
...
write.csv(overall_sex_stats, 
          file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_Rewards_byactivationpercent_allneurons_bysex.csv", 
          row.names = FALSE)
```
...
ggsave('./SocOp_MYT1L_snRNAseq_SS19_240328/results/intermed_figs/250225_rewardsbyactivity_betacoeffs.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave('./SocOp_MYT1L_snRNAseq_SS19_240328/results/final_figs/250225_rewardsbyactivity_betacoeffs_sigonly.pdf',
  device = pdf,
  width = 5,
  height = 10.5)
```
...
# # # Write the results to a CSV file
write.csv(cluster_regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_sac_rewards_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("./SocOp_MYT1L_snRNAseq_SS19_240328/results/SacRewardsbyActivatedPercentage_250213", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/SacRewardsbyActivatedPercentage_250213/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# # Write the results to a CSV file
write.csv(regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_sacrewards_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/SacRewardsbyActivatedPercentage_250213/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
overall_sample_percentages <- cluster_ieg_sample_df %>%
  ...
  summarise(
    Total_Cells = n(),
    Activated_Cells = sum(rowSums(across(all_oTf(filtered_iegs)) > 0) >= 2),
    SacRewards = dplyr::first(SacRewards)
  ) %>%
  dplyr::mutate(Activated_Percentage = Activated_Cells / Total_Cells * 100) %>%
  ungroup()
...
# Save the  plot
pdf(file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/SacRewardsbyActivatedPercentage_250213/control_all_neurons_plot.pdf", 
    width = 6, height = 8)
plot_control(overall_sample_percentages)
dev.off()
```
...
# Write results to CSV
write.csv(overall_stats,
          file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_sacrewards_byactivationpercent_allneurons.csv",
          row.names = FALSE)
```
...
# Save the control plot with sex
pdf(file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/SacRewardsbyActivatedPercentage_250213/control_all_neurons_plot_bySex.pdf",
    width = 6, height = 8)
plot_control_withsex(overall_sample_sex_percentages)
dev.off()
```
...
# Write results to CSV
write.csv(overall_sex_stats, 
          file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_sacrewards_byactivationpercent_allneurons_bysex.csv", 
          row.names = FALSE)
```
...
# # Write the results to a CSV file
write.csv(cluster_regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_Distance_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("./SocOp_MYT1L_snRNAseq_SS19_240328/results/DistancebyActivatedPercentage_250213", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/DistancebyActivatedPercentage_250213/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# Write the results to a CSV file
write.csv(regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_distance_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/DistancebyActivatedPercentage_250213/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
# # # Write the results to a CSV file
write.csv(cluster_regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_sac_distance_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("./SocOp_MYT1L_snRNAseq_SS19_240328/results/Sac_DistancebyActivatedPercentage_250213", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/Sac_DistancebyActivatedPercentage_250213/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# # Write the results to a CSV file
write.csv(regression_results, file = "./SocOp_MYT1L_snRNAseq_SS19_240328/results/250213_SacDistance_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("./SocOp_MYT1L_snRNAseq_SS19_240328/results/Sac_DistancebyActivatedPercentage_250213/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
