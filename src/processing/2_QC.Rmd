...
combined <- readRDS("/scratch/jdlab/simona/socop-hyp-snRNAseq/data/250219_combined_1-5_5pct.rds")
```
...
combined
```
You now have a SeuratObject that contains all the nuclei. A quick look the object shows that there are 37462  features (genes) and 184274 samples (nuclei). In the following quality control steps, we will be filtering out low quality nuclei and potential doublets. 
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/intermed-figs/250221_combined_genepernuc.png',
       device = png,
       width = 6,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/intermed-figs/250221_combined_UMIspernuc.png',
       device = png,
       width = 6,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/intermed-figs/250221_combined_mitopernuc.png',
       device = png,
       width = 6,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/intermed-figs/250221_combined_complexitypernuc.png',
       device = png,
       width = 6,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/intermed-figs/250221_combined_UMIvsgene.png',
       device = png,
       width = 6,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/intermed-figs/250221_combined_genesperfeature.png',
       device = png,
       width = 6,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/intermed-figs/250221_combined_medians.png',
       device = png,
       width = 6,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/final-figs/250221_combined_1-5_5pct_genoQC.pdf',
       device = pdf,
       width = 9,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/processing/final-figs/250221_combined_1-5_5pct_sexQC.pdf',
       device = pdf,
       width = 9,
       height = 3)
```
...
# Save 
```{r save data}
saveRDS(combined, "/scratch/jdlab/simona/socop-hyp-snRNAseq/data/250221_combined_postQC_1-5_5pct.rds")
```
