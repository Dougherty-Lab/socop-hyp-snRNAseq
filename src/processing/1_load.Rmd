...
```{r save processed}
saveRDS(processed, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/data/250219_processed_1-5_5pct.rds")
```
...
saveRDS(combined, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/data/250219_combined_1-5_5pct.rds")
```
