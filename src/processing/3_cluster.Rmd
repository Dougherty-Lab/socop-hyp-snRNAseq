...
clustree(combined_postQC, prefix = 'RNA_snn_res.', layout = "sugiyama")
 ...
 ggsave(filename = "../../results/processing/intermed-figs/250221_clustertree.pdf",
        width = 8,
        height = 8,
        dpi = 300)
```
...
ggsave(filename = "../../results/processing/final-figs/250221_umap_combined_postQC_1-5_5pct_res2.pdf",
       width = 12,
       height = 12,
       dpi = 300)
```
...
DimPlot_scCustom(combined_postQC,
 ...
 ggsave(filename = "../../results/processing/intermed-figs/250221_umap_combined_postQC_1-5_5pct_bysample.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
dir.create("../../results/processing/intermed-figs/IterateCluster_combined_postQC_1-5_5pct_res2_50dims_250221")

Iterate_Cluster_Highlight_Plot(combined_postQC,
                               highlight_color = 'navy',
                               background_color = 'lightgrey',
                               file_path = "../../results/processing/intermed-figs/IterateCluster_combined_postQC_1-5_5pct_res2_50dims_250221/",
                               file_name = 'iterate',
                               file_type = '.png',
                               raster = FALSE,
                               dpi = 100)
