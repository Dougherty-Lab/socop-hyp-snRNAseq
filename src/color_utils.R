...
region_muted_colors <- c(
  "Amygdala/Hypothalamus" = "#88CCEE", "Hypothalamus" = "#332288", "Midbrain" = "#DDCC77",
...
# Large Palettes
palette_90 <- c(
  "#FFE5B4", "#E6B8AF", "#F5DEB3", "#D8BFD8", "#B0E0E6", "#FFDAB9",
...
palette_43 <- c(
  "#C69DAF", "#B984A7", "#B2B2B2", "#8CAC94", "#78A5A6", "#D7A69E",
