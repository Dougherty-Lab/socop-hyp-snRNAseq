...
# Load in data
```{r load in data}
combined.neuronal <- readRDS("/scratch/jdlab/simona/socop-hyp-snRNAseq/data/250228_combined.neuronal_1-5_5pct.rds")
combined.neuronal
```
...
expr_freq <- tapply(binary_expr, WT.only$Sac_Learner, mean) * 100

VlnPlot_scCustom(WT.only[,gene_expr > 0],
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250214_FosGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
gene_expr <- GetAssayData(WT.only, slot = "data")["Jun",]
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250214_JunGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
gene_expr <- GetAssayData(WT.only, slot = "data")["Arc",]
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250214_ArcGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
write.csv(cluster_ieg_Sex_comparison, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_activationpercent_bysex.csv", row.names = FALSE)
```
...
# # Write the results to a CSV file
write.csv(cluster_ieg_Learner_comparison, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_activationpercent_bylearner.csv", row.names = FALSE)
```
...
cluster_ieg_sex_df <- data.frame(
  Cluster = Idents(WT.only),
  Sample = WT.only@meta.data$sample,
  Sex = WT.only@meta.data$sex,
  ieg_expression
)
...
cluster_ieg_sex_percentages$Cluster <- factor(cluster_ieg_sex_percentages$Cluster,
                                              levels = sort(as.character(levels(WT.only))))
...
wrap_plots(p1, p2)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303-activationbySex_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
cluster_ieg_Learner_df <- data.frame(
  Cluster = Idents(WT.only),
  Sample = WT.only@meta.data$sample,
  Learner = WT.only@meta.data$Sac_Learner,
  ieg_expression
)
...
wrap_plots(p1, p2)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303-activationbyLearner_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303-activationbyLearner_neuronal_1-5_5pct_50_1.8_sigonly.pdf',
       device = pdf,
       width = 5,
       height = 8)
```
...
Idents(WT.only) <- WT.only$cell_type
...
cluster_ieg_sample_df <- data.frame(
  ...
  Sex = WT.only$sex,
  Sample = WT.only$sample,
  TotalRewards = WT.only$Avg_Total_Rewards, 
  ieg_expression
)
...
# # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_rewards_byactivationpercent.csv", row.names = FALSE)
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_rewards_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
cluster_ieg_Learner_sample_df <- data.frame(
  Cluster = Idents(WT.only),
  Sample = WT.only$sample,
  Sac_Learner = WT.only$Sac_Learner, 
  TotalRewards = WT.only$Avg_Total_Rewards, 
  ieg_expression
)
...
# Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_rewards_byactivationpercent_bysaclearner.csv", row.names = FALSE)
```
...
for (cluster in clusters_to_plot) {
  print(cluster)
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot_bySac_Learner.pdf"), width = 6, height = 8)
...
for (cluster in problem_clusters) {
  print(cluster)
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot_bySac_Learner_noabline.pdf"), width = 6, height = 8)
...
# Save the  plot
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/control_all_neurons_plot.pdf",
   width = 6, height = 8)
...
write.csv(overall_stats,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_Rewards_byactivationpercent_allneurons.csv",
          row.names = FALSE)
```
...
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/control_all_neurons_plot_bySex.pdf",
    width = 6, height = 8)
...
write.csv(overall_sex_stats, 
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_Rewards_byactivationpercent_allneurons_bysex.csv", 
          row.names = FALSE)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/intermed-figs/250225_rewardsbyactivity_betacoeffs.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250225_rewardsbyactivity_betacoeffs_sigonly.pdf',
  device = pdf,
  width = 5,
  height = 10.5)
```
...
cluster_ieg_sample_df <- data.frame(
  ...
  Sex = WT.only$sex,
  Sample = WT.only$sample,
  SacRewards = WT.only$Sac_Total_Rewards,  
  ieg_expression
)
...
# # # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_sac_rewards_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/SacRewardsbyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/SacRewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# # Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_sacrewards_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/SacRewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
# Save the  plot
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/SacRewardsbyActivatedPercentage_250303/control_all_neurons_plot.pdf", 
    width = 6, height = 8)
plot_control(overall_sample_percentages)
dev.off()
```
...
# Write results to CSV
write.csv(overall_stats,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_sacrewards_byactivationpercent_allneurons.csv",
          row.names = FALSE)
```
...
# Save the control plot with sex
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/SacRewardsbyActivatedPercentage_250303/control_all_neurons_plot_bySex.pdf",
    width = 6, height = 8)
plot_control_withsex(overall_sample_sex_percentages)
dev.off()
```
...
# Write results to CSV
write.csv(overall_sex_stats, 
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_sacrewards_byactivationpercent_allneurons_bysex.csv", 
          row.names = FALSE)
```
...
cluster_ieg_sample_df <- data.frame(
  ...
  Sex = WT.only$sex,
  Sample = WT.only$sample,
  Distance = WT.only$Avg_Test_Distance,  
  ieg_expression
)
...
# # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_Distance_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/DistancebyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_distance_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
cluster_ieg_sample_df <- data.frame(
  ...
  Sex = WT.only$sex,
  Sample = WT.only$sample,
  SacDistance = WT.only$Sac_Test_Distance,
  ieg_expression
)
...
# # # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_sac_distance_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/Sac_DistancebyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/Sac_DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# # Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_SacDistance_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/Sac_DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
  # Create the plot
  plot_cluster_withsex(cluster, regression_results, cluster_ieg_Sex_sample_percentages)
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_genemodulescore_results_rewards.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/RewardsbyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_genemodulescore_results_sac_rewards.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/sac_rewardsbyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/sac_rewardsbyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
## Distance
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_genemodulescore_results_distance.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/distancebyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/distancebyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/250303_genemodulescore_results_sac_distance.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/sac_distancebyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity_WTonly/sac_distancebyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
