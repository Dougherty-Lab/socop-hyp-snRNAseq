...
ggsave(
  filename = "../results/IEGactivity_WTonly/250214_FosGEX_bylearner.pdf",
  device = pdf,
  width = 6,
  height = 8
)
...
ggsave(
  filename = "../results/IEGactivity_WTonly/250214_JunGEX_bylearner.pdf",
  device = pdf,
  width = 6,
  height = 8
)
...
ggsave(
  filename = "../results/IEGactivity_WTonly/250214_ArcGEX_bylearner.pdf",
  device = pdf,
  width = 6,
  height = 8
)
...
# Save the  plot
pdf(
  file = "../results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/control_all_neurons_plot.pdf",
  width = 6, height = 8
)
...
pdf(
  file = "../results/IEGactivity_WTonly/RewardsbyActivatedPercentage_250303/control_all_neurons_plot_bySex.pdf",
  width = 6, height = 8
)
...
# Save the  plot
pdf(
  file = "../results/IEGactivity_WTonly/SacRewardsbyActivatedPercentage_250303/control_all_neurons_plot.pdf",
  width = 6, height = 8
)
plot_control(overall_sample_percentages)
dev.off()
...
# Save the control plot with sex
pdf(
  file = "../results/IEGactivity_WTonly/SacRewardsbyActivatedPercentage_250303/control_all_neurons_plot_bySex.pdf",
  width = 6, height = 8
)
plot_control_withsex(overall_sample_sex_percentages)
dev.off()
