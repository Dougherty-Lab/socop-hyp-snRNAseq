...
ggplot(filtered_props, aes(x = -log10(P.Value), 
 ...
 ggsave(filename = "../results/proportions/250301_sexdiff_pvalues_hypovother_sigonly.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
ggplot(filtered_props, aes(x = -log10(FDR), 
 ...
 ggsave(filename = "../results/proportions/intermed-figs/250301_learnerprops_pvalues_hypovother_sigonly.pdf",
        width = 6,
        height = 8,
        dpi = 300)
```
