...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bygeno.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bygeno.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_proportionsbyGeno_1-5_5pct_res1.8_50dims_neuronal.png',
       device = png,
       width = 12,
       height = 8)
```
...
write.csv(props.geno, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_props_Geno_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
props.geno
```
...
combined.neuronal$cell_type <- as.factor(combined.neuronal$cell_type)

# Get the unique values and store them
unique_cell_types <- unique(as.character(combined.neuronal$cell_type))

# Set the levels in reverse order
levels(combined.neuronal$cell_type) <- rev(unique_cell_types)

cluster.set <- rev(levels(combined.neuronal$cell_type))
...
cell_idents <- combined.neuronal$cell_type
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_propsbyGeno_sigonly.pdf',
       device = pdf,
       width = 20,
       height = 4)
```
...
ggplot(props.geno, aes(x = -log10(P.Value), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_genodiff_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
gene_expr <- GetAssayData(combined.neuronal, slot = "data")["Moxd1",]
...
expr_freq <- tapply(binary_expr, combined.neuronal$sex, mean) * 100

# Plot non-zero values only
VlnPlot_scCustom(combined.neuronal[,gene_expr > 0],
                 group.by = "sex",
                 features = "Moxd1",
                 pt.size = 1) +
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_Moxd1GEX_bysex.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
moxd1_data <- data.frame(
  ...
  sex = combined.neuronal$sex,
  Moxd1 = GetAssayData(combined.neuronal, slot = "data")["Moxd1",]
)
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_Moxd1props_bysex.pdf',
       device = pdf,
       width = 6,
       height = 8)
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_proportionsbySex_1-5_5pct_res1.8_50dims_neuronal.png',
       device = png,
       width = 12,
       height = 8)
```
...
write.csv(props.sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_props_Sex_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
props.sex
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_propsandDEGsbySex_sigonly.pdf',
       device = pdf,
       width = 20,
       height = 4)
```
...
ggplot(props.sex, aes(x = -log10(P.Value), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_sexdiff_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
ggplot(filtered_props, aes(x = -log10(P.Value), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_sexdiff_pvalues_hypovother.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
dissector_data <- read.csv("/scratch/jdlab/simona/socop-hyp-snRNAseq/data/073123_Dissector_forR.csv", stringsAsFactors = FALSE)
...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_umap_neuronal_bydissector.png",
        width = 12,
        height = 12,
        dpi = 300)
...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_pca_neuronal_bydissector.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal.pdf',
       device = pdf,
       width = 12,
       height = 8)

p1
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal_final.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
write.csv(props.dissector, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_props_Dissector_neuronal_1-5_5pct_50_1.8.csv", row.names = TRUE)
props.dissector
```
...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(combined.neuronal,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_proportionsbyLearner_1-5_5pct_res1.8_50dims_neuronal.png',
       device = png,
       width = 12,
       height = 8)
```
...
write.csv(props.learner, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_props_Learner_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
```
...
ggsave("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_propsbyLearner_sigonly.pdf",
       device = pdf,
       width = 12,
       height = 6)
```
...
write.csv(res.combined,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_props_Learner_Sex_neuronal_1-5_5pct_50dims.csv",
          row.names = FALSE)
```
...
ggplot(props.learner, aes(x = -log10(FDR ), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_learnerprops_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
Geno <- combined.neuronal@meta.data$genotype
Sex <- as.factor(combined.neuronal@meta.data$sex)
# Create a data frame with sample information
sample_info <- data.frame(sample = combined.neuronal$sample, 
                          Geno = Geno,
...
# Write to CSV
write.csv(res.combined,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_props_Geno_Sex_Interaction_neuronal.csv",
          row.names = FALSE)
```
...
write.csv(model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_rewardsbyprops.csv")
```
...
write.csv(model_summary_sex_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_rewardsbyprops_sex.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_learner_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions//intermed-tables/250301_rewardsbyprops_learner.csv")
```
...
write.csv(new_model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-tables/250301_rewardsbyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-tables/250301_rewardsbypropsandsex_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_learner, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-tables/250301_rewardsbypropsandlearner_untransformed.csv")
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/RewardsbyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/RewardsbyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/RewardsbyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/RewardsbyProp_Figs/p", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/RewardsbyProp_Figs/cluster_", cluster, "_plotwithLearner.pdf"), width = 6, height = 8)
...
p_beta
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_rewardsbyprops_betacoeffs.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_propsbyLearnerandbetacoeffsforRewards_sigonly.pdf',
       device = pdf,
       width = 20,
       height = 4)
```
...
ggplot(model_summary_df, aes(x = -log10(bh_adjusted_pvalues), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-figs/250301_rewardsprops_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
ggplot(filtered_model_summary_df, aes(x = -log10(bh_adjusted_pvalues), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_rewardsprops_pvalues_hypovother.pdf",
        width = 6,
        height = 8,
        dpi = 300)
```
...
write.csv(model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_distancebyprops.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_sex_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_distancebyprops_sex.csv")
...
write.csv(new_model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-tables/250301_distancebyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/intermed-tables/250301_distancebypropsandsex_untransformed.csv")
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/DistancebyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/DistancebyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/DistancebyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
...
p_beta
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_distancebyprops_betacoeffs.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
md <- data.frame(
  sample <- combined.neuronal$sample,
  genotype <- combined.neuronal$genotype,
  sex <- combined.neuronal$sex,
  celltype <- combined.neuronal$cell_type
)
...
res <- compute_lisi(Embeddings(combined.neuronal, reduction = "umap"), md,
                    perplexity = 200,
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_lisi_genotype.png',
       device = png,
       width = 5,
       height = 3)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions/250301_lisi_sex.png',
       device = png,
       width = 5,
       height = 3)
```
