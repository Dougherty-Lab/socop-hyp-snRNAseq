...
myt.only <- subset(combined.neuronal, subset = genotype == "Het")
...
celldistribution <- data.frame(table(myt.only@meta.data$cell_type, myt.only@meta.data$sample))
...
cluster.set <- rev(levels(myt.only$cell_type))

cells.per.cluster <- c(table(myt.only$cell_type)[as.character(cluster.set)])
counts <- GetAssayData(myt.only, assay = "RNA", slot = "counts")
cell_idents <- myt.only$cell_type
...
DimPlot_scCustom(myt.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(myt.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
gene_expr <- GetAssayData(myt.only, slot = "data")["Moxd1",]
...
expr_freq <- tapply(binary_expr, myt.only$sex, mean) * 100

# Plot non-zero values only
VlnPlot_scCustom(myt.only[,gene_expr > 0],
                 group.by = "sex",
                 features = "Moxd1",
                 pt.size = 1) +
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_Moxd1GEX_bysex.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
moxd1_data <- data.frame(
  sample = myt.only$sample,
  sex = myt.only$sex,
  Moxd1 = GetAssayData(myt.only, slot = "data")["Moxd1",]
)
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_Moxd1props_bysex.pdf',
       device = pdf,
       width = 6,
       height = 8)
...
mean_norm_count_M_M1 <- calcnums$mean_norm_count[calcnums$Sample == "Het_M_1"]
...
cluster_order <- rev(sort(levels(myt.only)))
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_proportionsbySex_1-5_5pct_res1.8_50dims_neuronal.png',
       device = png,
       width = 12,
       height = 8)
```
...
```{r propeller by sex}
props.sex <- propeller(clusters = myt.only@meta.data$cell_type, sample = myt.only$sample, group = myt.only$sex, transform = "logit")

write.csv(props.sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_props_Sex_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
props.sex
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_propsandDEGsbySex_sigonly.pdf',
       device = pdf,
       width = 20,
       height = 4)
```
...
ggplot(props.sex, aes(x = -log10(P.Value), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_sexdiff_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
ggplot(filtered_props, aes(x = -log10(P.Value), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_sexdiff_pvalues_hypovother.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
metadata <- merge(myt.only@meta.data, dissector_data, by = "sample", all.x = TRUE, sort = FALSE)

# Set the rownames of the merged metadata to the preserved rownames
rownames(metadata) <- rownames(myt.only@meta.data) 

dim(metadata)
dim(myt.only@meta.data)

myt.only@meta.data <- metadata

myt.only$Dissector <- factor(myt.only$Dissector)
levels(myt.only$Dissector) <- c("Din", "Simona")
```
...
DimPlot_scCustom(myt.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_umap_neuronal_bydissector.png",
        width = 12,
        height = 12,
        dpi = 300)
...
DimPlot_scCustom(myt.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_pca_neuronal_bydissector.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
mean_norm_count_WT_M1 <- calcnums$mean_norm_count[calcnums$Sample == "Het_M_1"]
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal.pdf',
       device = pdf,
       width = 12,
       height = 8)

p1
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal_final.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
props.dissector <- propeller(clusters = myt.only@meta.data$cell_type, sample = myt.only$sample, group = myt.only$Dissector, transform = "logit")

write.csv(props.dissector, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_props_Dissector_neuronal_1-5_5pct_50_1.8.csv", row.names = TRUE)
props.dissector
```
...
DimPlot_scCustom(myt.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(myt.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
sample_to_learner <- myt.only@meta.data %>%
...
mean_norm_count_NL_M10 <- calcnums$mean_norm_count[calcnums$Sample == "Het_M_10"]
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_proportionsbyLearner_1-5_5pct_res1.8_50dims_neuronal.png',
       device = png,
       width = 12,
       height = 8)
```
...
props.learner <- propeller(clusters = myt.only@meta.data$cell_type, sample = myt.only$sample, group = myt.only$Sac_Learner, transform = "logit")

write.csv(props.learner, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_props_Learner_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
```
...
ggsave("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_propsbyLearner_sigonly.pdf",
       device = pdf,
       width = 12,
       height = 6)
```
...
props <- getTransformedProps(clusters = myt.only$cell_type, 
                                  sample = myt.only$sample, 
                                  transform = "logit")
```
...
var1 <- myt.only@meta.data$Sac_Learner

# Create a data frame with sample information
sample_info <- data.frame(sample = myt.only$sample, 
                          var1 = var1)
...
Sac_Learner <- myt.only@meta.data$Sac_Learner
Sex <- as.factor(myt.only@meta.data$sex)
...
write.csv(res.combined,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_props_Learner_Sex_neuronal_1-5_5pct_50dims.csv",
          row.names = FALSE)
```
...
ggplot(props.learner, aes(x = -log10(FDR ), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_learnerprops_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
props <- getTransformedProps(cluster = myt.only$cell_type, 
                                  sample = myt.only$sample, 
                                  transform = "logit")
...
# Create a data frame with sample information
sample_info <- data.frame(sample = myt.only$sample, 
                          distance = myt.only$Avg_Test_Distance,
                          rewards = myt.only$Avg_Total_Rewards,
                          time = myt.only$Avg_Exp_Zone_Time,
                          entries = myt.only$Avg_Exp_Zone_Entries,
                          clusters = myt.only$cell_type,
                          geno = myt.only$genotype,
                          sex = myt.only$sex,
                          learner = myt.only$Sac_Learner)
...
write.csv(model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_rewardsbyprops.csv")
```
...
write.csv(model_summary_sex_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_rewardsbyprops_sex.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_learner_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly//intermed-tables/250301_rewardsbyprops_learner.csv")
```
...
write.csv(new_model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-tables/250301_rewardsbyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-tables/250301_rewardsbypropsandsex_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_learner, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-tables/250301_rewardsbypropsandlearner_untransformed.csv")
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/RewardsbyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/RewardsbyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/RewardsbyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/RewardsbyProp_Figs/p", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/RewardsbyProp_Figs/cluster_", cluster, "_plotwithLearner.pdf"), width = 6, height = 8)
...
p_beta
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_rewardsbyprops_betacoeffs.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_propsbyLearnerandbetacoeffsforRewards_sigonly.pdf',
       device = pdf,
       width = 20,
       height = 4)
```
...
ggplot(model_summary_df, aes(x = -log10(bh_adjusted_pvalues), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-figs/250301_rewardsprops_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
ggplot(filtered_model_summary_df, aes(x = -log10(bh_adjusted_pvalues), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_rewardsprops_pvalues_hypovother.pdf",
        width = 6,
        height = 8,
        dpi = 300)
```
...
# Create contingency table of significant vs non-significant clusters by region
model_summary_df$significant <- model_summary_df$Props.p.value < 0.05
...
write.csv(model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_distancebyprops.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_sex_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/250301_distancebyprops_sex.csv")
...
write.csv(new_model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-tables/250301_distancebyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/intermed-tables/250301_distancebypropsandsex_untransformed.csv")
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/DistancebyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/DistancebyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_Mytonly/DistancebyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
