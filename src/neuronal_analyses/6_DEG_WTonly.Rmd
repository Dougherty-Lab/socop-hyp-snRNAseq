...
write.csv(t, "../../results/neuronal_analyses/GEX_WTonly/250301_tableofcellspergenotype.csv",
  quote = FALSE,
  row.names = TRUE
)
```
...
for (name in cluster_names) {
  ...
  if (length(unique(cluster_metadata$sex)) > 1) {
    ...
    write.csv(sig_res, paste0("../../results/neuronal_analyses/GEX_WTonly/Sex/", name.cleaned, " signif genes.csv"),
      quote = FALSE,
      row.names = TRUE
    )
...
for (name in cluster_names) {
  ...
  if (length(unique(cluster_metadata$Sac_Learner)) > 1) {
    ...
    # Write results to file
    name.cleaned <- gsub("/", "_", name)
    write.csv(sig_res, paste0("../../results/neuronal_analyses/GEX_WTonly/Learner/", name.cleaned, " signif genes.csv"),
      quote = FALSE,
      row.names = TRUE
    )
...
file_list <- list.files("../../results/neuronal_analyses/GEX_WTonly/Sex/", pattern = "signif genes.csv", full.names = TRUE)
...
results_wt_only$file <- sub("../../results/neuronal_analyses/GEX_WTonly/Sex//", "", results_wt_only$file)
results_wt_only$file <- sub(" signif genes.csv", "", results_wt_only$file)

write.csv(results_wt_only, file = "../../results/neuronal_analyses/GEX_WTonly/DEG table.csv", sep = ",")
```
...
comb.plot
ggsave("../../results/neuronal_analyses/GEX_WTonly/intermed-figs/250301_DEGsbySexall.png",
  device = png,
  width = 6,
  height = 6
)
...
ggsave(
  filename = "../../results/neuronal_analyses/GEX_WTonly/intermed-figs/250301_DEGsbysex_sig.png",
  width = 8,
  height = 12,
  dpi = 300
)
...
file_list <- list.files("../../results/neuronal_analyses/GEX_WTonly/Sex", pattern = "signif genes.csv", full.names = TRUE)
file_list <- sub("../../results/neuronal_analyses/GEX_WTonly/Sex/", "", results_wt_only$file)


concatenated_data <- data.frame()

for (file in file_list) {
  current_data <- read.csv(paste0("../../results/neuronal_analyses/GEX_WTonly/Sex/", file, " signif genes.csv"), sep = ",", header = TRUE)
...
write.csv(concatenated_data, file = "../../results/neuronal_analyses/GEX_WTonly/Sex/250301_DEGs_table.csv")
```
...
write_csv(uniqueDEGs, file = "../../results/neuronal_analyses/GEX_WTonly/Sex/250301_uniqueDEGs.csv")
```
...
ggsave(
  filename = "../../results/neuronal_analyses/GEX_WTonly/250301_PO-MEA-BST-Mixed-Gaba_volcano.pdf",
  width = 6,
  height = 4,
  device = pdf
)
...
ggsave(
  filename = "../../results/neuronal_analyses/GEX_WTonly/250301_PO-MEA-BST-Mixed-Gaba_volcano_noXYgenes.pdf",
  width = 6,
  height = 4,
  device = pdf
)
...
file_list <- list.files("../../results/neuronal_analyses/GEX_WTonly/Learner", pattern = "signif genes.csv", full.names = TRUE)
...
results_wt_only$file <- sub("../../results/neuronal_analyses/GEX_WTonly/Learner/", "", results_wt_only$file)
results_wt_only$file <- sub(" signif genes.csv", "", results_wt_only$file)

write.csv(results_wt_only, file = "../../results/neuronal_analyses/GEX_WTonly/Learner/DEG table.csv", sep = ",")
```
...
comb.plot
ggsave("../../results/neuronal_analyses/GEX_WTonly/intermed-figs/250301_DEGsbyLearnerall.png",
  device = png,
  width = 6,
  height = 6
)
...
ggsave(
  filename = "../../results/neuronal_analyses/GEX_WTonly/250301_DEGsbylearner.png",
  width = 8,
  height = 12,
  dpi = 300
)
...
file_list <- sub("../../results/neuronal_analyses/GEX_WTonly/Learner/", "", results_wt_only$file)

concatenated_data <- data.frame()

for (file in file_list) {
  current_data <- read.csv(paste0("../../results/neuronal_analyses/GEX_WTonly/Learner/", file, " signif genes.csv"), sep = ",", header = TRUE)
  if (dim(current_data)[1] > 0) {
    current_data$cellType <- sub("signif genes.csv", "", file)
    concatenated_data <- rbind(concatenated_data, current_data)
  }
...
write.csv(concatenated_data, file = "../../results/neuronal_analyses/GEX_WTonly/Learner/250301-DEGs_table.csv")
```
...
write_csv(uniqueDEGs, file = "../../results/neuronal_analyses/GEX_WTonly/Learner/250301_uniqueDEGs.csv")
```
...
ggsave(
  filename = "../../results/neuronal_analyses/GEX_WTonly/250301_PH-LHA-PVH-SO-PVa-Nxph4-Glut_learner_volcano.png",
  width = 6,
  height = 4,
  device = png
)
...
# GO Analysis
go_table <- read.csv(paste0("../../results/neuronal_analyses/GEX_WTonly/Learner/", name, " signif genes.csv"),
  sep = ",",
  header = TRUE
)
...
ggsave(paste0("../../results/neuronal_analyses/GEX_WTonly/Learner/", name, " GO enrichment dotplot.png"),
  device = png,
  width = 5,
  height = 7
)
...
p
# Save plot
ggsave("../../results/neuronal_analyses/GEX_WTonly/Learner/cluster_GO_enrichment_dotplot.png",
  plot = p,
  width = 12,
  height = 10
)
