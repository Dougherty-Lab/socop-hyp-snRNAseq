...
write.csv(t, "../../results/neuronal_analyses/GEX/250301_tableofcellspergenotype.csv",
  quote = FALSE,
  row.names = TRUE
)
```
...
for (name in cluster_names) {
  ...
  write.csv(sig_res, paste0("../../results/neuronal_analyses/GEX/Geno/", name.cleaned, " signif genes.csv"),
    quote = FALSE,
    row.names = TRUE
  )
}
...
for (name in cluster_names) {
  ...
  name.cleaned <- gsub("/", "_", name)
  write.csv(sig_res, paste0("../../results/neuronal_analyses/GEX/Sex/", name.cleaned, " signif genes.csv"),
    quote = FALSE,
    row.names = TRUE
  )
}
...
for (name in cluster_names) {
  ...
  name.cleaned <- gsub("/", "_", name)
  write.csv(sig_res, paste0("../../results/neuronal_analyses/GEX/Learner/", name.cleaned, " signif genes.csv"),
    quote = FALSE,
    row.names = TRUE
  )
}
