...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
  width = 12,
  height = 12,
  dpi = 300
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
  width = 12,
  height = 12,
  dpi = 300
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/250301_Moxd1GEX_bysex.pdf",
  device = pdf,
  width = 6,
  height = 8
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/250301_Moxd1props_bysex.pdf",
  device = pdf,
  width = 6,
  height = 8
)
...
wrap_plots(p1, p2, p4)
ggsave("../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_proportionsbySex_1-5_5pct_res1.8_50dims_neuronal.png",
  device = png,
  width = 12,
  height = 8
)
...
write.csv(props.sex, file = "../../results/neuronal_analyses/proportions_WTonly/250301_props_Sex_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
props.sex
```
...
ggsave("../../results/neuronal_analyses/proportions_WTonly/250301_propsandDEGsbySex_sigonly.pdf",
  device = pdf,
 width = 20,
 height = 4
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_sexdiff_pvalues_hypovother.pdf",
  width = 12,
  height = 12,
  dpi = 300
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/250301_sexdiff_pvalues_hypovother.pdf",
  width = 8,
  height = 12,
  dpi = 300
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/250301_umap_neuronal_bydissector.png",
  width = 12,
  height = 12,
  dpi = 300
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_pca_neuronal_bydissector.png",
  width = 12,
  height = 12,
  dpi = 300
)
...
wrap_plots(p1, p2, p4)
ggsave("../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal.pdf",
  device = pdf,
  width = 12,
  height = 8
)
...
p1
ggsave("../../results/neuronal_analyses/proportions_WTonly/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal_final.pdf",
  device = pdf,
  width = 12,
  height = 8
)
...
write.csv(props.dissector, file = "../../results/neuronal_analyses/proportions_WTonly/250301_props_Dissector_neuronal_1-5_5pct_50_1.8.csv", row.names = TRUE)
props.dissector
```
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
  width = 12,
  height = 12,
  dpi = 300
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
  width = 12,
  height = 12,
  dpi = 300
)
...
wrap_plots(p1, p2, p4)
ggsave("../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_proportionsbyLearner_1-5_5pct_res1.8_50dims_neuronal.png",
  device = png,
  width = 12,
  height = 8
)
...
write.csv(props.learner, file = "../../results/neuronal_analyses/proportions_WTonly/250301_props_Learner_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
```
...
ggsave("../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_propsbyLearner_sigonly.pdf",
  device = pdf,
  width = 12,
  height = 6
)
...
write.csv(res.combined,
  file = "../../results/neuronal_analyses/proportions_WTonly/250301_props_Learner_Sex_neuronal_1-5_5pct_50dims.csv",
  row.names = FALSE
)
```
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_learnerprops_pvalues_hypovother.pdf",
  width = 12,
  height = 12,
  dpi = 300
)
...
write.csv(model_summary_df, file = "../../results/neuronal_analyses/proportions_WTonly/250301_rewardsbyprops.csv")
```
...
write.csv(model_summary_sex_df, file = "../../results/neuronal_analyses/proportions_WTonly/250301_rewardsbyprops_sex.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_learner_df, file = "../../results/neuronal_analyses/proportions_WTonly/intermed-tables/250301_rewardsbyprops_learner.csv")
```
...
write.csv(new_model_summary_df, file = "../../results/neuronal_analyses/proportions_WTonly/intermed-tables/250301_rewardsbyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "../../results/neuronal_analyses/proportions_WTonly/intermed-tables/250301_rewardsbypropsandsex_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_learner, file = "../../results/neuronal_analyses/proportions_WTonly/intermed-tables/250301_rewardsbypropsandlearner_untransformed.csv")
```
...
dir.create("../../results/neuronal_analyses/proportions_WTonly/RewardsbyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("../../results/neuronal_analyses/proportions_WTonly/RewardsbyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("../../results/neuronal_analyses/proportions_WTonly/RewardsbyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("../../results/neuronal_analyses/proportions_WTonly/RewardsbyProp_Figs/p", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("../../results/neuronal_analyses/proportions_WTonly/RewardsbyProp_Figs/cluster_", cluster, "_plotwithLearner.pdf"), width = 6, height = 8)
...
p_beta
ggsave("../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_rewardsbyprops_betacoeffs.pdf",
  device = pdf,
  width = 6,
  height = 8
)
...
ggsave("../../results/neuronal_analyses/proportions_WTonly/250301_propsbyLearnerandbetacoeffsforRewards_sigonly.pdf",
  device = pdf,
  width = 20,
  height = 4
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/intermed-figs/250301_rewardsprops_pvalues_hypovother.pdf",
  width = 12,
  height = 12,
  dpi = 300
)
...
ggsave(
  filename = "../../results/neuronal_analyses/proportions_WTonly/250301_rewardsprops_pvalues_hypovother.pdf",
  width = 6,
  height = 8,
  dpi = 300
)
...
write.csv(model_summary_df, file = "../../results/neuronal_analyses/proportions_WTonly/250301_distancebyprops.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_sex_df, file = "../../results/neuronal_analyses/proportions_WTonly/250301_distancebyprops_sex.csv")
```
...
write.csv(new_model_summary_df, file = "../../results/neuronal_analyses/proportions_WTonly/intermed-tables/250301_distancebyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "../../results/neuronal_analyses/proportions_WTonly/intermed-tables/250301_distancebypropsandsex_untransformed.csv")
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("../../results/neuronal_analyses/proportions_WTonly/DistancebyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("../../results/neuronal_analyses/proportions_WTonly/DistancebyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("../../results/neuronal_analyses/proportions_WTonly/DistancebyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
...
ggsave("../../results/neuronal_analyses/proportions_WTonly/250301_lisi_sex.pdf",
  device = pdf,
  width = 5,
  height = 3
)
