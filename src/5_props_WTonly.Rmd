...
celldistribution <- data.frame(table(WT.only@meta.data$cell_type, WT.only@meta.data$sample))
...
levels(WT.only$cell_type) <- rev(unique(as.character(WT.only$cell_type)))

cluster.set <- rev(levels(WT.only$cell_type))

cells.per.cluster <- c(table(WT.only$cell_type)[as.character(cluster.set)])
counts <- GetAssayData(WT.only, assay = "RNA", slot = "counts")
cell_idents <- WT.only$cell_type
...
DimPlot_scCustom(WT.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(WT.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bysex.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
gene_expr <- GetAssayData(WT.only, slot = "data")["Moxd1",]
...
expr_freq <- tapply(binary_expr, WT.only$sex, mean) * 100
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_Moxd1GEX_bysex.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
moxd1_data <- data.frame(
  ...
  sex = WT.only$sex,
  Moxd1 = GetAssayData(WT.only, slot = "data")["Moxd1",]
)
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_Moxd1props_bysex.pdf',
       device = pdf,
       width = 6,
       height = 8)
...
cluster_order <- rev(sort(levels(WT.only)))
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_proportionsbySex_1-5_5pct_res1.8_50dims_neuronal.png',
       device = png,
       width = 12,
       height = 8)
```
...
```{r propeller by sex}
props.sex <- propeller(clusters = WT.only@meta.data$cell_type, sample = WT.only$sample, group = WT.only$sex, transform = "logit")

write.csv(props.sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_props_Sex_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
props.sex
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_propsandDEGsbySex_sigonly.pdf',
       device = pdf,
       width = 20,
       height = 4)
```
...
ggplot(props.sex, aes(x = -log10(FDR), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_sexdiff_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
ggplot(filtered_props, aes(x = -log10(FDR), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_sexdiff_pvalues_hypovother.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
metadata <- merge(WT.only@meta.data, dissector_data, by = "sample", all.x = TRUE, sort = FALSE)

# Set the rownames of the merged metadata to the preserved rownames
rownames(metadata) <- rownames(WT.only@meta.data) 

dim(metadata)
dim(WT.only@meta.data)

WT.only@meta.data <- metadata

WT.only$Dissector <- factor(WT.only$Dissector)
levels(WT.only$Dissector) <- c("Din", "Simona")
```
...
DimPlot_scCustom(WT.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_umap_neuronal_bydissector.png",
        width = 12,
        height = 12,
        dpi = 300)
...
DimPlot_scCustom(WT.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_pca_neuronal_bydissector.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal.pdf',
       device = pdf,
       width = 12,
       height = 8)

p1
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_proportionsbyDissector_1-5_5pct_res1.8_50dims_neuronal_final.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
props.dissector <- propeller(clusters = WT.only@meta.data$cell_type, sample = WT.only$sample, group = WT.only$Dissector, transform = "logit")

write.csv(props.dissector, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_props_Dissector_neuronal_1-5_5pct_50_1.8.csv", row.names = TRUE)
props.dissector
```
...
DimPlot_scCustom(WT.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_umap_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
DimPlot_scCustom(WT.only,
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_pca_1-5_5pct_res1.8_50dims_neuronal_bylearner.png",
        width = 12,
        height = 12,
        dpi = 300)
```
...
sample_to_learner <- WT.only@meta.data %>%
...
wrap_plots(p1, p2, p4)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_proportionsbyLearner_1-5_5pct_res1.8_50dims_neuronal.png',
       device = png,
       width = 12,
       height = 8)
```
...
props.learner <- propeller(clusters = WT.only@meta.data$cell_type, sample = WT.only$sample, group = WT.only$Sac_Learner, transform = "logit")

write.csv(props.learner, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_props_Learner_1-5_5pct_res1.8_50dims_neuronal.csv", row.names = TRUE)
```
...
ggsave("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_propsbyLearner_sigonly.pdf",
       device = pdf,
       width = 12,
       height = 6)
```
...
props <- getTransformedProps(clusters = WT.only$cell_type, 
                                  sample = WT.only$sample, 
                                  transform = "logit")
```
...
var1 <- WT.only@meta.data$Sac_Learner

# Create a data frame with sample information
sample_info <- data.frame(sample = WT.only$sample, 
                          var1 = var1)
...
Sac_Learner <- WT.only@meta.data$Sac_Learner
Sex <- as.factor(WT.only@meta.data$sex)
...
write.csv(res.combined,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_props_Learner_Sex_neuronal_1-5_5pct_50dims.csv",
          row.names = FALSE)
```
...
ggplot(props.learner, aes(x = -log10(FDR ), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_learnerprops_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
props <- getTransformedProps(cluster = WT.only$cell_type, 
                                  sample = WT.only$sample, 
                                  transform = "logit")
...
sample_info <- data.frame(sample = WT.only$sample, 
                          ...
                          rewards = WT.only$Avg_Total_Rewards,
                          time = WT.only$Avg_Exp_Zone_Time,
                          entries = WT.only$Avg_Exp_Zone_Entries,
                          clusters = WT.only$cell_type,
                          geno = WT.only$genotype,
                          sex = WT.only$sex,
...
write.csv(model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_rewardsbyprops.csv")
```
...
write.csv(model_summary_sex_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_rewardsbyprops_sex.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_learner_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly//intermed-tables/250301_rewardsbyprops_learner.csv")
```
...
write.csv(new_model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-tables/250301_rewardsbyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-tables/250301_rewardsbypropsandsex_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_learner, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-tables/250301_rewardsbypropsandlearner_untransformed.csv")
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/RewardsbyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/RewardsbyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/RewardsbyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/RewardsbyProp_Figs/p", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/RewardsbyProp_Figs/cluster_", cluster, "_plotwithLearner.pdf"), width = 6, height = 8)
...
p_beta
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_rewardsbyprops_betacoeffs.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_propsbyLearnerandbetacoeffsforRewards_sigonly.pdf',
       device = pdf,
       width = 20,
       height = 4)
```
...
ggplot(model_summary_df, aes(x = -log10(bh_adjusted_pvalues), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-figs/250301_rewardsprops_pvalues_hypovother.pdf",
        width = 12,
        height = 12,
        dpi = 300)
```
...
ggplot(filtered_model_summary_df, aes(x = -log10(bh_adjusted_pvalues), 
 ...
 ggsave(filename = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_rewardsprops_pvalues_hypovother.pdf",
        width = 6,
        height = 8,
        dpi = 300)
```
...
write.csv(model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_distancebyprops.csv")
```
...
# Write the data frame to a CSV file
write.csv(model_summary_sex_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_distancebyprops_sex.csv")
...
write.csv(new_model_summary_df, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-tables/250301_distancebyprops_untransformed.csv")
```
...
# Write the data frame to a CSV file
write.csv(new_model_summary_df_sex, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/intermed-tables/250301_distancebypropsandsex_untransformed.csv")
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/DistancebyProp_Figs", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/DistancebyProp_Figs/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/DistancebyProp_Figs/cluster_", cluster, "_plotwithSex.pdf"), width = 6, height = 8)
...
res <- compute_lisi(Embeddings(WT.only, reduction = "umap"), md,
                    perplexity = 200,
                    c('sample', 'sex'))
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/proportions_WTonly/250301_lisi_sex.pdf',
       device = pdf,
       width = 5,
       height = 3)
```
