...
sig.comb.plot
 ...
 ggsave(filename = "../results/GEX/intermed-figs/250301_DEGsbygeno_sig.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
ggsave(filename = "../results/GEX/250301_TH-Sema5b-Ntrk-Glut_geno_volcano.pdf",
       width = 6,
       height = 4,
       device = pdf)
```
...
# GO Analysis
go_table <- read.csv(paste0("../results/GEX/Geno/", name, " signif genes.csv"), sep = ',',
                     header = TRUE)
...
sig_plot
 ...
 ggsave(filename = "../results/GEX/intermed-figs/250219_DEGsbysex_sig.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
ggsave(filename = "../results/GEX/250301_PO-MEA-BST-Mixed-Gaba_volcano.pdf", 
       width = 6,
       height = 4,
       device = pdf)
```
...
ggsave(filename = "../results/GEX/250301_PO-MEA-BST-Mixed-Gaba_volcano_noXYgenes.pdf", 
       width = 6,
       height = 4,
       device = pdf)
```
...
sig.comb.plot
 ...
 ggsave(filename = "../results/GEX/250301_DEGsbylearner.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
ggsave(filename = "../results/GEX/250301_PH-LHA-PVH-SO-PVa-Nxph4-Glut_learner_volcano.pdf",
       width = 6,
       height = 4,
       device = pdf)
```
...
# GO Analysis
go_table <- read.csv(paste0("../results/GEX/Learner/", name, " signif genes.csv"), sep = ',',
                     header = TRUE)
