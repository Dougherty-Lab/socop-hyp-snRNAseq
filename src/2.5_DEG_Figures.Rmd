...
file_list <- list.files("../ej_results/GEX/Geno", pattern = "signif genes.csv", full.names = TRUE)
...
results_df$file <- sub("../ej_results/GEX/Geno/", "", results_df$file)
results_df$file <- sub(" signif genes.csv", "", results_df$file)

write.csv(results_df, file = "../ej_results/GEX/Geno/DEG table.csv")
```
...
comb.plot
ggsave('../ej_results/GEX/intermed-figs/250301_DEGsbyGenoall.pdf',
       device = pdf,
       width = 6,
       height = 6)
```
...
sig.comb.plot
 ...
 ggsave(filename = "../ej_results/GEX/intermed-figs/250301_DEGsbygeno_sig.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
file_list <- list.files("../ej_results/GEX/Geno", pattern = "signif genes.csv", full.names = TRUE)
file_list <- sub("../ej_results/GEX/Geno/", "", results_df$file)

concatenated_data <- data.frame()

for (file in file_list){
  current_data <- read.csv(paste0("../ej_results/GEX/Geno/", file, " signif genes.csv"), sep = ',', header = TRUE)
...
write.csv(concatenated_data, file = '../ej_results/GEX/Geno/DEGs_table.csv')
```
...
write_csv(uniqueDEGs, file = "../ej_results/GEX/Geno/uniqueDEGs.csv")
```
...
ggsave(filename = "../ej_results/GEX/250301_TH-Sema5b-Ntrk-Glut_geno_volcano.pdf",
       width = 6,
       height = 4,
       device = pdf)
```
...
# GO Analysis
go_table <- read.csv(paste0("../ej_results/GEX/Geno/", name, " signif genes.csv"), sep = ',',
                     header = TRUE)
...
ggsave(paste0("../ej_results/GEX/Geno/", name, " GO enrichment dotplot.pdf"),
       device = pdf,
       width = 5,
       height = 5)
```
...
p
# Save plot
ggsave("../ej_results/GEX/Geno/cluster_GO_enrichment_dotplot.pdf",
       plot = p,
       width = 12,
       height = 10)
```
...
file_list <- list.files("../ej_results/GEX/Sex/", pattern = "signif genes.csv", full.names = TRUE)
...
results_df$file <- sub("../ej_results/GEX/Sex//", "", results_df$file)
results_df$file <- sub(" signif genes.csv", "", results_df$file)

write.csv(results_df, file = "../ej_results/GEX/DEG table.csv", sep = ",")
```
...
comb.plot
ggsave('../ej_results/GEX/intermed-figs/250301_DEGsbySexall.pdf',
       device = pdf,
       width = 6,
       height = 6)
```
...
sig_plot
 ...
 ggsave(filename = "../ej_results/GEX/intermed-figs/250219_DEGsbysex_sig.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
file_list <- list.files("../ej_results/GEX/Sex", pattern = "signif genes.csv", full.names = TRUE)
file_list <- sub("../ej_results/GEX/Sex/", "", results_df$file)


concatenated_data <- data.frame()

for (file in file_list){
  current_data <- read.csv(paste0("../ej_results/GEX/Sex/", file, " signif genes.csv"), sep = ',', header = TRUE)
  if(dim(current_data)[1] > 0) {
  current_data$cellType <- sub("signif genes.csv", "", file)
  concatenated_data <- rbind(concatenated_data, current_data)
  }
...
write.csv(concatenated_data, file = '../ej_results/GEX/Sex/250301_DEGs_table.csv')
```
...
write_csv(uniqueDEGs, file = "../ej_results/GEX/Sex/250301_uniqueDEGs.csv")
```
...
ggsave(filename = "../ej_results/GEX/250301_PO-MEA-BST-Mixed-Gaba_volcano.pdf", 
       width = 6,
       height = 4,
       device = pdf)
```
...
ggsave(filename = "../ej_results/GEX/250301_PO-MEA-BST-Mixed-Gaba_volcano_noXYgenes.pdf", 
       width = 6,
       height = 4,
       device = pdf)
```
...
file_list <- list.files("../ej_results/GEX/Learner", pattern = "signif genes.csv", full.names = TRUE)
...
results_df$file <- sub("../ej_results/GEX/Learner/", "", results_df$file)
results_df$file <- sub(" signif genes.csv", "", results_df$file)

write.csv(results_df, file = "../ej_results/GEX/Learner/DEG table.csv")
```
...
comb.plot
ggsave('../ej_results/GEX/intermed-figs/250301_DEGsbyLearnerall.pdf',
       device = pdf,
       width = 6,
       height = 6)
```
...
sig.comb.plot
 ...
 ggsave(filename = "../ej_results/GEX/250301_DEGsbylearner.pdf",
        width = 8,
        height = 12,
        dpi = 300)
```
...
file_list <- sub("../ej_results/GEX/Learner/", "", results_df$file)

concatenated_data <- data.frame()

for (file in file_list){
  current_data <- read.csv(paste0("../ej_results/GEX/Learner/", file, " signif genes.csv"), sep = ',', header = TRUE)
  if(dim(current_data)[1] > 0) {
  current_data$cellType <- sub("signif genes.csv", "", file)
  concatenated_data <- rbind(concatenated_data, current_data)
  }
...
write.csv(concatenated_data, file = '../ej_results/GEX/Learner/250301-DEGs_table.csv')
```
...
write_csv(uniqueDEGs, file = "../ej_results/GEX/Learner/250301_uniqueDEGs.csv")
```
...
ggsave(filename = "../ej_results/GEX/250301_PH-LHA-PVH-SO-PVa-Nxph4-Glut_learner_volcano.pdf",
       width = 6,
       height = 4,
       device = pdf)
```
...
# GO Analysis
go_table <- read.csv(paste0("../ej_results/GEX/Learner/", name, " signif genes.csv"), sep = ',',
                     header = TRUE)
...
ggsave(paste0("../ej_results/GEX/Learner/", name, " GO enrichment dotplot.pdf"),
       device = pdf,
       width = 5,
       height = 7)
```
...
p
# Save plot
ggsave("../ej_results/GEX/Learner/cluster_GO_enrichment_dotplot.pdf",
       plot = p,
       width = 12,
       height = 10)
```
