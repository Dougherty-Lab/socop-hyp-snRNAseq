...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_genemodulescore_results.csv')
```
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/intermed-figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
```
