...
gene_expr <- GetAssayData(combined.neuronal, slot = "data")["Fos",]
...
expr_freq <- tapply(binary_expr, combined.neuronal$Sac_Learner, mean) * 100
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250214_FosGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
gene_expr <- GetAssayData(combined.neuronal, slot = "data")["Jun",]
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250214_JunGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
gene_expr <- GetAssayData(combined.neuronal, slot = "data")["Arc",]
...
ggsave(filename = '/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250214_ArcGEX_bylearner.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ieg_expression <- FetchData(combined.neuronal, vars = iegs)
...
Idents(combined.neuronal) <- combined.neuronal@meta.data$cell_type

# Fetch expression data for all IEGs
ieg_expression <- FetchData(combined.neuronal, vars = filtered_iegs)

# Create a data frame with cluster assignments, genotype, sample, and IEG expression
cluster_ieg_genotype_sample_df <- data.frame(
  Cluster = Idents(combined.neuronal),
...
write.csv(cluster_ieg_genotype_comparison, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_activationpercent_bygeno.csv", row.names = FALSE)
```
...
# # Write the results to a CSV file
write.csv(cluster_ieg_Sex_comparison, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_activationpercent_bysex.csv", row.names = FALSE)
```
...
# # Write the results to a CSV file
write.csv(cluster_ieg_Learner_comparison, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_activationpercent_bylearner.csv", row.names = FALSE)
```
...
cluster_ieg_Geno_df <- data.frame(
  Cluster = Idents(combined.neuronal),
  Sample = combined.neuronal@meta.data$sample,
...
cluster_ieg_Geno_percentages$Cluster <- factor(cluster_ieg_Geno_percentages$Cluster,
                                              levels = sort(as.character(levels(combined.neuronal))))
...
wrap_plots(p1, p2)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303-activationbyGeno_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
cluster_ieg_sex_df <- data.frame(
  Cluster = Idents(combined.neuronal),
  Sample = combined.neuronal@meta.data$sample,
  Sex = combined.neuronal@meta.data$sex,
  ieg_expression
)
...
wrap_plots(p1, p2)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303-activationbySex_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303-activationbySex_neuronal_1-5_5pct_50_1.8_sigonly.pdf',
       device = pdf,
       width = 5,
       height = 8)
```
...
cluster_ieg_Learner_df <- data.frame(
  Cluster = Idents(combined.neuronal),
  Sample = combined.neuronal@meta.data$sample,
  Learner = combined.neuronal@meta.data$Sac_Learner,
  ieg_expression
)
...
wrap_plots(p1, p2)
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303-activationbyLearner_neuronal_1-5_5pct_50_1.8.pdf',
       device = pdf,
       width = 12,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303-activationbyLearner_neuronal_1-5_5pct_50_1.8_sigonly.pdf',
       device = pdf,
       width = 5,
       height = 8)
```
...
Idents(combined.neuronal) <- combined.neuronal$cell_type
...
cluster_ieg_sample_df <- data.frame(
  ...
  Sex = combined.neuronal$sex,
  Sample = combined.neuronal$sample,
  TotalRewards = combined.neuronal$Avg_Total_Rewards, 
  ieg_expression
)
...
# # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_rewards_byactivationpercent.csv", row.names = FALSE)
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_rewards_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
cluster_ieg_Learner_sample_df <- data.frame(
  Cluster = Idents(combined.neuronal),
  Sample = combined.neuronal$sample,
  Sac_Learner = combined.neuronal$Sac_Learner, 
  TotalRewards = combined.neuronal$Avg_Total_Rewards, 
  ieg_expression
)
...
# Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_rewards_byactivationpercent_bysaclearner.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot_bySac_Learner.pdf"), width = 6, height = 8)
...
# Save the  plot
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyActivatedPercentage_250303/control_all_neurons_plot.pdf",
   width = 6, height = 8)
...
write.csv(overall_stats,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_Rewards_byactivationpercent_allneurons.csv",
          row.names = FALSE)
```
...
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyActivatedPercentage_250303/control_all_neurons_plot_bySex.pdf",
    width = 6, height = 8)
...
write.csv(overall_sex_stats, 
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_Rewards_byactivationpercent_allneurons_bysex.csv", 
          row.names = FALSE)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/intermed-figs/250225_rewardsbyactivity_betacoeffs.pdf',
       device = pdf,
       width = 6,
       height = 8)
```
...
ggsave('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250225_rewardsbyactivity_betacoeffs_sigonly.pdf',
  device = pdf,
  width = 5,
  height = 10.5)
```
...
cluster_ieg_sample_df <- data.frame(
  ...
  Sex = combined.neuronal$sex,
  Sample = combined.neuronal$sample,
  SacRewards = combined.neuronal$Sac_Total_Rewards,  
  ieg_expression
)
...
# # # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_sac_rewards_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/SacRewardsbyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/SacRewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# # Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_sacrewards_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/SacRewardsbyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
# Save the  plot
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/SacRewardsbyActivatedPercentage_250303/control_all_neurons_plot.pdf", 
    width = 6, height = 8)
plot_control(overall_sample_percentages)
dev.off()
```
...
# Write results to CSV
write.csv(overall_stats,
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_sacrewards_byactivationpercent_allneurons.csv",
          row.names = FALSE)
```
...
# Save the control plot with sex
pdf(file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/SacRewardsbyActivatedPercentage_250303/control_all_neurons_plot_bySex.pdf",
    width = 6, height = 8)
plot_control_withsex(overall_sample_sex_percentages)
dev.off()
```
...
# Write results to CSV
write.csv(overall_sex_stats, 
          file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_sacrewards_byactivationpercent_allneurons_bysex.csv", 
          row.names = FALSE)
```
...
# # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_Distance_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/DistancebyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_distance_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
cluster_ieg_sample_df <- data.frame(
  ...
  Sex = combined.neuronal$sex,
  Sample = combined.neuronal$sample,
  SacDistance = combined.neuronal$Sac_Test_Distance,
  ieg_expression
)
...
# # # Write the results to a CSV file
write.csv(cluster_regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_sac_distance_byactivationpercent.csv", row.names = FALSE)
```
...
# Create a directory to save the PDFs if it doesn't exist
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/Sac_DistancebyActivatedPercentage_250303", showWarnings = FALSE)

# Iterate through clusters
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/Sac_DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot.pdf"), width = 6, height = 8)
...
# # Write the results to a CSV file
write.csv(regression_results, file = "/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_SacDistance_byactivationpercent_bysex.csv", row.names = FALSE)
```
...
for (cluster in clusters) {
  # Open a PDF device
  pdf(file = paste0("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/Sac_DistancebyActivatedPercentage_250303/cluster_", cluster, "_plot_bySex.pdf"), width = 6, height = 8)
...
combined.neuronal <- AddModuleScore(
  object = combined.neuronal,
  features = ieg_lst,
  pool = NULL,
  nbin = 24,
  ctrl = 100,
...
```{r set up dataframe}
sample_info = combined.neuronal@meta.data %>% 
  dplyr::select(
  sample, 
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_genemodulescore_results_rewards.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/RewardsbyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_genemodulescore_results_sac_rewards.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/sac_rewardsbyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/sac_rewardsbyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
## Distance
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_genemodulescore_results_distance.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/distancebyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/distancebyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
...
model_summary_df %>% 
  write_csv('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/250303_genemodulescore_results_sac_distance.csv')
```
...
dir.create("/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/sac_distancebyModuleScore_Figs", showWarnings = FALSE)
...
for (ct in cts){
  plot_df = sample_info %>% 
    ...
    print(pp)
    ct_name = gsub('/', '-', ct)
    ggsave(paste0('/scratch/jdlab/simona/socop-hyp-snRNAseq/results/IEGactivity/sac_distancebyModuleScore_Figs/250303_linearplot_', ct_name, '_genemodulescore.pdf'), pp, width = 5, height = 3.5)
  }
```
