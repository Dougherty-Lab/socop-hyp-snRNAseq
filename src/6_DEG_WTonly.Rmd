...
results_wt_only <- data.frame(file = character(), 
                         F_enrich = integer(), 
                         M_enrich = integer(), 
...
for (file in file_list) {
  ...
  results_wt_only <- rbind(results_wt_only, 
...
sig_plot
 ...
 ggsave(filename = "../results/GEX_WTonly/intermed-figs/250301_DEGsbysex_sig.png",
        width = 8,
        height = 12,
        dpi = 300)
```
...
ggsave(filename = "../results/GEX_WTonly/250301_PO-MEA-BST-Mixed-Gaba_volcano.pdf", 
       width = 6,
       height = 4,
       device = pdf)
```
...
ggsave(filename = "../results/GEX_WTonly/250301_PO-MEA-BST-Mixed-Gaba_volcano_noXYgenes.pdf", 
       width = 6,
       height = 4,
       device = pdf)
```
...
sig.comb.plot
 ...
 ggsave(filename = "../results/GEX_WTonly/250301_DEGsbylearner.png",
        width = 8,
        height = 12,
        dpi = 300)
```
...
ggsave(filename = "../results/GEX_WTonly/250301_PH-LHA-PVH-SO-PVa-Nxph4-Glut_learner_volcano.png",
       width = 6,
       height = 4,
       device = png)
```
...
# GO Analysis
go_table <- read.csv(paste0("../results/GEX_WTonly/Learner/", name, " signif genes.csv"), sep = ',',
                     header = TRUE)
